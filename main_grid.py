...
FILE = "/BYBIT_DOGEUSDT_SPOT_2021_2026.csv"
...
TP_LIST = [0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1, 1.05, 1.1, 1.15, 1.2, 1.25, 1.3, 1.35, 1.4, 1.45, 1.5, 1.55, 1.6, 1.65, 1.7, 1.75, 1.8, 1.85, 1.9, 1.95, 2, 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 2.8, 2.9, 3, 3.5, 4, 4.5, 5, 5.5, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10]  # 0.5..10.0 шаг 0.5

# Пространство поиска параметров сетки
SEARCH_SPACE = {
    "n_orders":  (35, 40),      # диапазон количества ордеров (целое)
    "step_min":  (0.1, 10),     # % минимальный шаг ордера
    "step_max":  (0.3, 10),     # % максимальный шаг ордера
    "size_min":  (2.5, 100),    # USDT минимальный размер ордера
    "size_max":  (20.0, 1000.0),  # USDT максимальный размер ордера
